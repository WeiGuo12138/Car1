...
void Oled_Order(uint16_t order)
{
	...
	{
		case 123 : 
			oled_showstring(2,3,strred);
			oled_showstring(2,8,strgreen);
			oled_showstring(2,15,strblue);
		break;
		case 132 : 
			oled_showstring(2,2,strred);
			oled_showstring(2,8,strblue);			
		  oled_showstring(2,14,strgreen);
		break;
		case 213 : 
			oled_showstring(2,2,strgreen);
			oled_showstring(2,9,strred);
			oled_showstring(2,14,strblue);			
		break;
		case 231:
			oled_showstring(2,2,strgreen);
			oled_showstring(2,9,strblue);	
		  oled_showstring(2,15,strred);
		break;
		case 312:			
			oled_showstring(2,2,strblue);	 
		  oled_showstring(2,8,strred);
			oled_showstring(2,14,strgreen);
		break;
		case 321:
			oled_showstring(2,2,strblue);	 
